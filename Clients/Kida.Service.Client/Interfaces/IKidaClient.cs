...
public interface IKidaClient
{
    ...
    ValueTask<AppPage> SearchAppsAsync(string? query = null, string? status = null, int page = 1, int pageSize = 20, CancellationToken cancellationToken = default) => ValueTask.FromException<AppPage>(new NotSupportedException());
